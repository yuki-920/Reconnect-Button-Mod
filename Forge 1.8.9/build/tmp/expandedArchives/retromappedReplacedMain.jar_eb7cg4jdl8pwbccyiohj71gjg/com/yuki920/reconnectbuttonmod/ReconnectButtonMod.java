...
public class ReconnectButtonMod {
    ...
    public void onGuiInit(GuiScreenEvent.InitGuiEvent.Post event) {
        if (event.gui instanceof GuiDisconnected) {
            ...
            if (backButton != null) {
                ...
                int buttonX = backButton.field_146128_h;
                int buttonY = backButton.field_146129_i + backButton.field_146121_g + 4;

                event.buttonList.add(new GuiButton(RECONNECT_BUTTON_ID, buttonX, buttonY, backButton.field_146120_f, 20, I18n.func_135052_a("gui.reconnectbuttonmod.reconnect")));
            }
        }
    }
    ...
    public void onGuiAction(GuiScreenEvent.ActionPerformedEvent.Post event) {
        if (event.gui instanceof GuiDisconnected && event.button.field_146127_k == RECONNECT_BUTTON_ID) {
